...
jpackage.exe --app-version 0.11 --runtime-image target\minijre --dest target --input CayoPericoHeistAssistant --name CayoPericoHeistAssistant --main-jar CayoPericoHeistAssistant.jar --type msi --win-menu --win-shortcut --win-dir-chooser --win-per-user-install
